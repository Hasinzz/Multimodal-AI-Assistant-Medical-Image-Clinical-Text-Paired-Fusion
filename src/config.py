...
DEFAULT_XRAY_CHECKPOINT = MODEL1_CHECKPOINT_DIR / "xray_best_model_gpu_large_v2.pt"
DEFAULT_BRAIN_CHECKPOINT = MODEL1_CHECKPOINT_DIR / "brain_best_model_gpu_final_v2.pt"
