...
INSTALL_HINTS = {
    "ultralytics": "python -m pip install ultralytics",
    "transformers": "python -m pip install transformers datasets evaluate seqeval accelerate",
    "datasets": "python -m pip install transformers datasets evaluate seqeval accelerate",
    "evaluate": "python -m pip install transformers datasets evaluate seqeval accelerate",
    "seqeval": "python -m pip install transformers datasets evaluate seqeval accelerate",
    "accelerate": "python -m pip install transformers datasets evaluate seqeval accelerate",
